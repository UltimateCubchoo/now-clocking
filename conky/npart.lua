...
${else}${if_match "" != "${exec playerctl -p rhythmbox status}"}${exec ./scripts/fetch-art Rhythmbox}
    ${image ./data/Rhythmbox.png -p 0,0 -s 125x125 -n}
${else}${if_match "" != "${exec playerctl -p audacious status}"}${exec ./scripts/fetch-art Audacious}
    ${image ./data/Audacious.png -p 0,0 -s 125x125 -n}    
